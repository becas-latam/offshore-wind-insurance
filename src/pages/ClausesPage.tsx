  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Clause Drafting</h1>
          <p className="text-sm text-muted-foreground">Generate insurance clauses from best practices</p>
        </div>
      </div>
      <div className="mt-12 flex flex-col items-center justify-center rounded-lg border border-dashed p-12 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Draft insurance clauses based on corpus best practices and German legal requirements.
        </p>
      </div>
    </div>
  )
